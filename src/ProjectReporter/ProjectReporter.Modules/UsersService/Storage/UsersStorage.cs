...
namespace ProjectReporter.Modules.UsersService.Storage
{
    public class UsersStorage : DbContext
    {
        ...
        public DbSet<Student> Admins { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Teacher>().Property(t => t.DateTimeCreated).ValueGeneratedOnAdd();
            modelBuilder.Entity<Teacher>().Property(t => t.DateTimeModified).ValueGeneratedOnAddOrUpdate();

            modelBuilder.Entity<Student>().HasIndex(s => s.UserId).IsUnique();
            modelBuilder.Entity<Student>().Property(s => s.DateTimeCreated).ValueGeneratedOnAdd();
            modelBuilder.Entity<Student>().Property(s => s.DateTimeModified).ValueGeneratedOnAddOrUpdate();
            ...
            modelBuilder.Entity<Admin>().Property(a => a.DateTimeCreated).ValueGeneratedOnAdd();
            modelBuilder.Entity<Admin>().Property(a => a.DateTimeModified).ValueGeneratedOnAddOrUpdate();
